...
/* Returns a string array with the season names */
string_array* mk_season_names();

/* Returns the season given the date 
   Here are the seasons (approximately):
   1. Spring: March 23 - June 22
   2. Summer: June 23 - September 22
   3. Fall: September 23 - December 22
   4. Winter: December 23 - March 22
*/
...
Returns holiday string like Christmas, NewYear, July4, etc. 
if daycode was a holiday. Since the daycodes are hard-coded
this function has been implemented for year's 
from 1998 to 2005
The function returns a NULL if daycode is not a holiday.

Reference site: http://www.opm.gov/fedhol/
*/
