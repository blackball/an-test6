...
{ /* I grabbed this little function from the web somewhere, tweaking it -- Pat */
  struct _timeb tb;
  ...
  *r_errmess = NULL;
  ...
  if ( *r_errmess == NULL )
  {
    ...
    if ( (year < 0) ||
         ...
         (year >= 100 && year < 1800) || 
	 (year > MAX_YEAR) )
      *r_errmess = mk_printf("I insist on years between 1800 and MAX_YEAR.\n"
...
static char *season_names[4] = {"Spring", "Summer", "Fall", "Winter"};

string_array* mk_season_names()
{
  return mk_string_array_from_array(season_names,4);
}

/* Input: 1 <= month <= 12.  
   Output: Returns the season name, which is a static string which should
           not be freed. 
*/
char* date_to_season(date* d)
{
  if( d->month < 3 )
    return season_names[3];
  else if(( d->month == 3 ) && ( d->day < 23 ))
    return season_names[3];
  else if( d->month < 6 )
    return season_names[0];
  else if(( d->month == 6 ) && ( d->day < 23 ))
    return season_names[0];
  else if( d->month < 9 )
    return season_names[1];
  else if(( d->month == 9 ) && ( d->day < 23 ))
    return season_names[1];
  else if( d->month < 12 )
    return season_names[2];
  else if(( d->month == 12 ) && ( d->day < 23 ))
    return season_names[2];
  else
    return season_names[3];
}
...
char* daycode_to_holiday_name(int daycode)
{
  char *result = NULL;

  switch (daycode)
  {
    case 72318: case 72683: case 73047:
    case 73414: case 73779: case 74144: case 74510: case 74874: 
         result = "New Year"; break;
    case 72336: case 72700: case 73064: 
    case 73428: case 73799: case 74163: case 74524: case 74891:
         result = "Martin Luther"; break;
    case 72364: case 72728: case 73099:
    case 73463: case 73827: case 74191: case 74559: case 74926:
         result = "Washington Birthday"; break;
    case 72462: case 72833: case 73197: 
    case 73561: case 73925: case 74289: case 74649: case 75024:
         result = "Memorial Day"; break;
    case 72501: case 72868: case 73233: 
    case 73598: case 73963: case 74328: case 74694: case 75059:
         result = "Independence Day"; break;
    case 72567: case 72931: case 73295: 
    case 73659: case 74023: case 74387: case 74756: case 75122:
         result = "Labor Day"; break;
    case 72602: case 72966: case 73330: 
    case 73694: case 74065: case 74429: case 74791: case 75157:
         result = "Columbus Day"; break;
    case 72632: case 72997: case 73362: 
    case 73729: case 74093: case 74458: case 74823: case 75189:
         result = "Veterans Day"; break;
    case 72647: case 73011: case 73375: 
    case 73739: case 74110: case 74474: case 74836: case 75202:
         result = "Thanksgiving Day"; break;
    case 72676: case 73040: case 73407: 
    case 73772: case 74137: case 74502: case 74868: case 75234:
         result = "Christmas Day"; break;
  }
