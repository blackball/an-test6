...
int main(int argc, char** args) {
	...
	if (idfn) {
		...
		qfits_header_add(id->header, "HISTORY", "This file was generated by the program \"cut_an\".", NULL, NULL);
	...
	qfits_header_add(cat->header, "HISTORY", "This file was generated by the program \"cut_an\".", NULL, NULL);
