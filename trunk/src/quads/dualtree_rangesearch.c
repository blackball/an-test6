...
void rs_handle_leaves(rs_params* p, kdtree_node_t* search, kdtree_node_t* ynode);
...
void rs_handle_leaves(rs_params* vparams, kdtree_node_t* xnode, kdtree_node_t* ynode) {
...
void rs_handle_result(void* vparams, kdtree_node_t* xnode, kdtree_node_t* ynode) {
    ...
    if (!kdtree_node_is_leaf(p->xtree, xnode)) {
		rs_handle_result(vparams, kdtree_get_child1(p->xtree, xnode), ynode);
		rs_handle_result(vparams, kdtree_get_child2(p->xtree, xnode), ynode);
		return;
    }

    if (!kdtree_node_is_leaf(p->ytree, ynode)) {
		rs_handle_result(vparams, xnode, kdtree_get_child1(p->ytree, ynode));
		rs_handle_result(vparams, xnode, kdtree_get_child2(p->ytree, ynode));
		return;
    }
