 ...
 * 	Date:
 * 	Purpose: This is the new home for most string_array functions. string_array is
 *		a dynamically resizable array of strings. Some of the functions and the declaration
 *		used to live in amiv.h.
 * Note that there are still a few string_array functions in amdmex.h. Some belong here,
 *  and some are esoteric that they should stay there. 
 */
...
string_array *mk_string_array_5(char *x1,char *x2,char *x3,char *x4,char *x5);
	/* Warning: The compiler won't catch type errors here. Pass the values as integers,
	   or behavior will be undefined (read: bad things will probably happen sometime) */
